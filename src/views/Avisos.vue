...
// 1. Datos de ejemplo para los avisos (Añadido 'leido' para el estado)
const avisos = ref([
  { id: 1, categoria: 'reservas', titulo: 'Reserva Confirmada', texto: 'Tu cabaña ha sido reservada con éxito. Consulta los detalles en tu perfil.', tiempo: 'Hace 15 minutos', leido: false },
  { id: 2, categoria: 'promocion', titulo: 'Oferta Especial', texto: '¡25% de descuento en tu próxima estancia si reservas este mes!', tiempo: 'Hace 2 horas', leido: false },
  { id: 3, categoria: 'reservas', titulo: 'Recordatorio Pago', texto: 'El saldo de tu reserva para la cabaña Mariposa está pendiente', tiempo: 'Hace 1 día', leido: true },
  { id: 4, categoria: 'actividades', titulo: 'Nueva Ruta Senderismo', texto: 'Descubre el sendero del Jaguar, una ruta guiada de 5 horas.', tiempo: 'Hace 3 días', leido: false },
  { id: 5, categoria: 'actividades', titulo: 'Clase de Yoga Matinal', texto: 'Inscríbete a la clase de yoga al amanecer. ¡Plazas limitadas!', tiempo: 'Hace 5 días', leido: true },
  { id: 6, categoria: 'promocion', titulo: 'Noche Adicional Gratis', texto: 'Reserva 3 noches y obtén la cuarta noche completamente gratis.', tiempo: 'Hace 1 semana', leido: false },
]);
