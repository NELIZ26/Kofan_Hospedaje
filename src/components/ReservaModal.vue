    ...
    <div class="modal-content">
      ...
      <form @submit.prevent="store.handleSubmit" novalidate>
        <div class="form-grid">
          <div class="form-group">
            ...
            />
            <span class="error-message" v-if="store.errors.nombres"
          ...
          <div class="form-group" v-if="store.personType === 'natural'">
            ...
            <span class="error-message" v-if="store.errors.tipoDocumento"
              >Seleccione uno.</span
            >
          </div>
          ...
          <div class="form-group">
            ...
            />
            <span class="error-message" v-if="store.errors.correo"
          ...
          <div class="form-group" v-if="store.personType === 'natural'">
            ...
            />
            <span class="error-message" v-if="store.errors.fechaNacimiento"
              >Requerido.</span
            >
          </div>
          ...
          <div class="form-group">
            ...
            />
            <span class="error-message" v-if="store.errors.numDocumento"
              >Ingrese número válido.</span
            >
          </div>
          ...
          <div class="form-group">
            ...
            />
            <span class="error-message" v-if="store.errors.telefono"
              >Requerido.</span
            >
          </div>
          ...
          <div class="form-group">
            ...
            />
            <span class="error-message" v-if="store.errors.fechaReserva"
              >Fecha inválida.</span
            >
          </div>
        </div>
      ...
      <div class="success-overlay" :class="{ active: store.showSuccess }">
        <div class="success-card">
          ...
          <p>
            Tu reserva ha sido registrada correctamente. Te contactaremos
            pronto.
          </p>
          <button
            class="btn-submit btn-small"
            @click="store.closeSuccessMessage"
          >
            Aceptar
          </button>
        </div>
